...
pass.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				if((bitmap == bitmap2)&&(pass.getInputType()==InputType.TYPE_TEXT_VARIATION_PASSWORD))
			    {
		...
		*/
		...
		void login(){
	        try{            
	            ...
	            httppost= new HttpPost("http://www.barat.co.nf/androidlogin/check.php"); // make sure the url is correct.
	            //add your data

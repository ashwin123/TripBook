...
//    Editor editor = sharedpreferences.edit();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Whats Trending, Will add a counter here
	...
	private void displayView(int position) {
			...
			
		{
                	...
                	fragment=new WhatsTrendingFragment();
		...
		case 6:
			...
			break;
		case 7:
			Intent intent = new Intent(MainActivity.this, homedelete.class);
